...
namespace TFModFortRisePickupRotate
{
  ...
  public class MyVariantToggle : IHookable
  {
    ...
    private static bool IsOurs(VariantToggle toggle)
    {
      ...
      return Same(shown, Variants.TITLE) || Same(shown, Variants.Rotate?.Name);
    }
    ...
    {
      TFModFortRisePickupRotateSettings s = TFModFortRisePickupRotateModule.Settings;
      ...
      return new List<VariantPopup.Field>
      {
        ...
        VariantPopup.Bool("ROTATE RIGHT 90", () => s.RotateRight90, v => s.RotateRight90 = v),
        VariantPopup.Bool("ROTATE LEFT 90", () => s.RotateLeft90, v => s.RotateLeft90 = v),
        VariantPopup.Bool("ROTATE 180", () => s.Rotate180, v => s.Rotate180 = v),
        VariantPopup.Bool("ROTATE 360", () => s.Rotate360, v => s.Rotate360 = v),
        VariantPopup.Bool("FLIP Y", () => s.FlipY, v => s.FlipY = v),
        VariantPopup.Bool("FLIP X", () => s.FlipX, v => s.FlipX = v),
        VariantPopup.Int("EFFECT TIME", () => s.EffectTime, v => s.EffectTime = v, 5, 100),
        VariantPopup.Int("EFFECT 360 TIME", () => s.Effect360Time, v => s.Effect360Time = v, 5, 100)
      };
    }
